# openhuman Archify Architecture
...
- Repository URL: https://github.com/hundong2/openhuman.git
- Checkout SHA: 8c7110fc0b27939f78018a4752d059de201e080c
- README file: README.md
- Evidence file: README.md
- README title: Install
- Dependency markers: JS/TS, Rust, pnpm
- Top-level directories: .agents, .cargo, .claude, .codex, .do, .fly, .husky
- Category: Agents and platforms

## 적용 프롬프트

~~~~text
Use Archify to create a high-level architecture diagram for openhuman.
...
주 경로는 `Developer / learner -> README and docs -> Setup and deps -> Entry points -> Agent platform core -> Actions / UI state`이다.
